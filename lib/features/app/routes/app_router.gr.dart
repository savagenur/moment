...
class SnapperShiftStartRoute extends _i7.PageRouteInfo<void> {
  const SnapperShiftStartRoute({List<_i7.PageRouteInfo>? children})
      : super(
  ...
  static _i7.PageInfo page = _i7.PageInfo(
    name,
    builder: (data) {
      return const _i5.SnapperShiftStartPage();
    },
  );
}
...
class SnapperShiftStartReportRoute extends _i7.PageRouteInfo<void> {
  const SnapperShiftStartReportRoute({List<_i7.PageRouteInfo>? children})
      : super(
  ...
  static _i7.PageInfo page = _i7.PageInfo(
    name,
    builder: (data) {
      return const _i6.SnapperShiftStartReportPage();
    },
  );
}
